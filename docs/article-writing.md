...
10. Favor concrete examples, comparisons, and caveats over filler. Use example scenarios that are common and ordinary for the target audience, not edge cases or unusual situations, so most readers can see themselves or someone they know in it. Prefer a specific, relatable, everyday situation (a parent asking a trusted colleague about a family they know, a Candidate hesitant to share their profile widely) over a generic or contrived one.
...
- Make hypothetical example characters and scenarios common and relatable, not unusual or edge-case. Draw the situation from something a typical reader in the target audience has plausibly lived or witnessed (a parent quietly asking around about a family before an introduction, a Candidate unsure whether to share their profile widely), not a rare or dramatic circumstance. The goal is "this could be me or someone I know," not a memorable but atypical story.
